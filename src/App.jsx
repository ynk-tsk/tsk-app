...
export default function App() {
  ...
  const handleLogin = (userData, redirectPath) => {
    setUser(userData);
    if (redirectPath) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        <Routes>
          ...
          <Route path="/auth" element={<AuthPage T={T} onLogin={handleLogin} />} />
          ...
          <Route path="/opportunity/:id" element={<OpportunityDetailPage T={T} user={user} onLoginRequest={(path) => navigate(`/auth?redirect=${encodeURIComponent(path)}`)} />} />
